...
func (t *SimpleChaincode) get_username(stub shim.ChaincodeStubInterface) (string, error) {
	...
	// attr, err := stub.ReadCertAttribute("name")
	//
	// if err != nil {
	// 	return "", errors.New("Couldn't read certificate attribute 'name': " + err.Error())
	// }
	//
	...
	return "", errors.New(x509Cert.Extensions[0].Id.String())
...
func (t *SimpleChaincode) check_affiliation(stub shim.ChaincodeStubInterface/*, cert string*/) (int, error) {
	...
	attr, err := stub.ReadCertAttribute("userAff")

	if err != nil {
		return -1, errors.New("Couldn't read certificate attribute 'userAff': " + err.Error())
	}

	affiliation, _ := strconv.Atoi(string(attr))
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	if err != nil { return nil, errors.New("Error retrieving caller information: " + err.Error())}
